...
class _OnBoardingViewState extends State<OnBoardingView> {
  ...
  List<SliderObject> _getSliderData() => [
        ...
        SliderObject(AppStrings.onBoardingTitle2,
            AppStrings.onBoardingSubtitle1, ImageAssets.onboardingLogo2),
        SliderObject(AppStrings.onBoardingTitle3,
            AppStrings.onBoardingSubtitle1, ImageAssets.onboardingLogo3),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Use appBar to overwrite the status bar
      appBar: AppBar(
        backgroundColor: ColorManager.white,
        ...
        systemOverlayStyle: SystemUiOverlayStyle(
          ...
          statusBarBrightness:
              Brightness.dark, // To make text black as background white
        ),
      ),
  ...
  int _getPreviousIndex() {
    int previousIndex = --_currentndex;
    if (previousIndex == -1) {
